...
class Admin_ext(commands.Cog):
    ...
    async def invites(self, ctx, page=0):
        ...
        embed = discord.Embed(title='**Purge**', description='Server\'s list',
                              colour=discord.Colour.blurple())
        embed.set_thumbnail(
            url='https://cdn.discordapp.com/attachments/814340239094317087/814346626771976223/Purge.png')
    ...
    @commands.command(brief='Purge?logout\nStop script')
